...
export const resourceGroups = {
  ...
  transport: [
    resource('/transport/agencies', 'Agences', '/api/agencies', { roles: ['SUPER_ADMIN', 'SERVICE_ADMIN'] }),
    resource('/transport/buses', 'Bus', '/api/buses', { roles: ['SUPER_ADMIN', 'SERVICE_ADMIN'] }),
    resource('/transport/drivers', 'Chauffeurs', '/api/drivers', { roles: ['SUPER_ADMIN', 'SERVICE_ADMIN'] }),
    resource('/transport/destinations', 'Destinations', '/api/destinations', { roles: ['SUPER_ADMIN', 'SERVICE_ADMIN'] }),
    resource('/transport/schedules', 'Horaires', '/api/schedules', { roles: ['SUPER_ADMIN', 'SERVICE_ADMIN'] }),
    resource('/transport/trips', 'Voyages', '/api/trips', { roles: ['SUPER_ADMIN', 'SERVICE_ADMIN'] }),
    resource('/transport/reservations', 'Réservations', '/api/reservations', { permission: 'VIEW_RESERVATION', createPermission: 'CREATE_RESERVATION', updatePermission: 'UPDATE_RESERVATION' }),
    resource('/transport/payments', 'Paiements', '/api/reservation-payments', { permission: 'VIEW_PAYMENT', readOnly: true }),
    resource('/transport/tickets', 'Billets', '/api/tickets', { permission: 'VIEW_RESERVATION', readOnly: true }),
    resource('/transport/parcels', 'Colis', '/api/parcels'),
    resource('/transport/seats', 'Sièges', '/api/seats', { unavailable: 'La liste des sièges requiert un identifiant de bus : GET /api/seats/:busId.' }),
  ],
  construction: [
    resource('/construction/projects', 'Projets', '/api/construction/projects', { labelKey: 'construction.nav.projects', permission: 'VIEW_PROJECT', createPermission: 'CREATE_PROJECT', updatePermission: 'UPDATE_PROJECT', deletePermission: 'DELETE_PROJECT' }),
    resource('/construction/templates', 'Projets templates', '/api/construction/projects', { permission: 'VIEW_PROJECT' }),
  ...
  automobile: [
    ...
    resource('/automobile/templates', 'Véhicules templates', '/api/vehicles', { permission: 'VIEW_VEHICLE' }),
