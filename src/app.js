...
const busMediaRoutes = require('./routes/busMedia');
...
const autoSalesDashboardRoutes = require('./routes/autoSalesDashboard');
...
const managerDashboardRoutes = require('./routes/managerDashboard');
...
const constructionDashboardRoutes = require('./routes/constructionDashboard');
...
const apiLimiter = rateLimit({
  windowMs: 15 * 60 * 1000,
  max: isTestEnv ? 2000 : 300,
  standardHeaders: true,
  legacyHeaders: false,
  skip: (req) => {
    const reqPath = req.path || '';
    return reqPath === '/health' || reqPath === '/api/health';
  },
  message: {
    success: false,
...
app.use('/api/bus-media', busMediaRoutes);
...
app.use('/api/construction/dashboard', constructionDashboardRoutes);
...
app.use('/api/dashboard/autosales', autoSalesDashboardRoutes);
