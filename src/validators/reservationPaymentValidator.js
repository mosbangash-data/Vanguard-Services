...
const validateReservationPaymentCreate = (req, res, next) => {
  const body = req.body;
...
const validateReservationPaymentUpdate = (req, res, next) => {
  const body = req.body;
...
module.exports = { validateReservationPaymentCreate, validateReservationPaymentUpdate };
