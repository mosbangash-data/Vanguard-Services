...
const { getExpectedRolePermissions } = require('../src/config/rbac');
...
async function main() {
  ...
  const rolePermissions = {
    SUPER_ADMIN: getExpectedRolePermissions('SUPER_ADMIN'),
    SERVICE_ADMIN: getExpectedRolePermissions('SERVICE_ADMIN'),
    MANAGER: getExpectedRolePermissions('MANAGER'),
    AGENT: getExpectedRolePermissions('AGENT'),
  };
